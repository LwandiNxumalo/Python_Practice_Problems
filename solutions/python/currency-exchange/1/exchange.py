...
def exchange_money(budget, exchange_rate):
    ...
    """
    estimated_value = round(budget / exchange_rate, 2)
...
def get_change(budget, exchanging_value):
    ...
    """
    budget_outstanding_balance = budget - exchanging_value
    return budget_outstanding_balance
    pass
...
def get_value_of_bills(denomination, number_of_bills):
    ...
    """
    calculated_bills = denomination * number_of_bills
    if calculated_bills % 2 != 0:
        total_value_of_bills = calculated_bills // bill
        return total_value_of_bills
    else:
        total_value_of_bills = calculated_bills
        return total_value_of_bills
    pass
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    total_unrounded = budget / effective_rate
    number_of_bills = int(total_unrounded // denomination)
